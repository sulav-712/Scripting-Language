...
<table border="1" cellpadding="<?= $cellPadding ?>">
    ...
    <tr><th>ID</th><th>Name</th><th>Course</th><th>Grade</th></tr>
...
<h2>=== JOIN Summary ===</h2>
<p>INNER JOIN: <?= $innerRows ?> rows (students with matching grades)</p>
<p>LEFT JOIN: <?= $leftRows ?> rows (all students)</p>
<p>RIGHT JOIN: <?= $rightRows ?> rows (all grades including orphans)</p>
