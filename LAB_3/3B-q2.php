/* A university offers various courses. Each time a student enrolls, the enrollment is logged. When the script ends, a summary of all enrollments is printed via destructors. */
